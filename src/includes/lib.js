 ...
 * object.
 *
 * <p>The string can contain any number of variables in the form of %var_name%.
 *
 * @example
 ...
 * @augments pwlib.appEvent
 *
 * @param {String} dataURI The data URI generated by the browser holding the 
 * pixels of the image being saved, in PNG format.
 * @param {Number} width The image width.
 * @param {Number} height The image height.
 */
pwlib.appEvent.imageSave = function (dataURI, width, height) {
  /**
